...
import numpy as npafrom flask import Flask, render_template_string, jsonify, request
import folium
from folium import plugins
from datetime import datetime, timedelta
import pandas as pd
...
# OpenAI import with backward compatibility
try:
...
if OPENAI_NEW_VERSION:
    ...
    openai_client = bool(os.getenv('OPENAI_API_KEY'))
